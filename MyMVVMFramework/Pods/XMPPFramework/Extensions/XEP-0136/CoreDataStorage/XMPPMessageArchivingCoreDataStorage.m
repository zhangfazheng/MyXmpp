...
- (XMPPMessageArchiving_Message_CoreDataObject *)messageWithJid:(XMPPJID *)messageJid
                                                               streamJid:(XMPPJID *)streamJid
                                                                outgoing:(BOOL)isOutgoing
                                                    managedObjectContext:(NSManagedObjectContext *)moc
{
...
- (void)archiveUpdateMessage:(XMPPMessage *)message outgoing:(BOOL)isOutgoing xmppStream:(XMPPStream *)xmppStream
{
    // Message should either have a body, or be a composing notification
    ...
    [self scheduleBlock:^{
        ...
        XMPPMessageArchiving_Message_CoreDataObject *archivedMessage =
        [self messageWithJid:messageJid
                            streamJid:myJid
                             outgoing:isOutgoing
                 managedObjectContext:moc];
