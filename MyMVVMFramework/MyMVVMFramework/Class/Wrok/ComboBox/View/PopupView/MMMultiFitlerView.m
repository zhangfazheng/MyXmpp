...
- (void)popupViewFromSourceFrame:(CGRect)frame completion:(void (^ __nullable)(void))completion {
    ...
    CGFloat top =  CGRectGetMaxY(self.sourceFrame)+NAVIGATION_BAR_HEIGHT;
    CGFloat maxHeight = ScreenHeight - DistanceBeteewnPopupViewAndBottom - top - PopupViewTabBarHeight;
    CGFloat resultHeight = MIN(maxHeight, MAX(self.item.childrenNodes.count, self.minRowNumber)  * PopupViewRowHeight);
    self.frame = CGRectMake(0, top, ScreenWidth, 0);
    ...
    //add ShadowView
    self.shadowView.frame = CGRectMake(0, top, ScreenWidth, ScreenHeight - top);
    ...
    [UIView animateWithDuration:AnimationDuration animations:^{
        self.frame = CGRectMake(0, top, ScreenWidth, resultHeight);
